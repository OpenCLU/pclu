...
const OWN_req ce_ownreqs = { 0, 0 };

errcode
ce_own_init_proc(void)
{
    errcode err;
    enter_own_init_proc();
    if (ce_own_init == 0) {
        ...
        add_selector_info("code", 0, (struct OPS *)int_ops);
        add_selector_info("kind", 1, (struct OPS *)oneof_expr_gen_opgen_ownvar_tconst_tparm_typeset_unknown_var_vparm_ops);
        find_selector_ops("record", 2, &(record_code_kind_ops));
        add_parm_info_type(0, (const struct OPS *)string_ops, table_of_key_reqs);
        add_parm_info_type(1, (const struct OPS *)record_code_kind_ops, table_of_val_reqs);
        ...
        add_selector_info("args", 0, (struct OPS *)sequence_of_typespec_ops);
        add_selector_info("gen", 1, (struct OPS *)du_ops);
        add_selector_info("sigs", 2, (struct OPS *)sequence_of_record_name_types_ops);
        add_selector_info("vals", 3, (struct OPS *)sequence_of_typespec_ops);
        ...
        add_selector_info("du", 0, (struct OPS *)record_gen_parms_ops);
        add_selector_info("op", 1, (struct OPS *)record_name_parms_type__ops);
        add_selector_info("return_", 2, (struct OPS *)typespec_ops);
        ...
        add_selector_info("gen", 0, (struct OPS *)du_ops);
        add_selector_info("parms", 1, (struct OPS *)sequence_of_record_sel_type__ops);
        ...
        add_selector_info("any_", 0, (struct OPS *)null_ops);
        add_selector_info("apply", 1, (struct OPS *)record_args_gen_sigs_vals_ops);
        add_selector_info("cluster_", 2, (struct OPS *)record_gen_parms_ops);
        add_selector_info("cvt_", 3, (struct OPS *)null_ops);
        add_selector_info("idn", 4, (struct OPS *)idn_ops);
        add_selector_info("other", 5, (struct OPS *)oneof_du_op_return__ops);
        add_selector_info("select", 6, (struct OPS *)record_gen_parms_1_ops);
        add_selector_info("type_", 7, (struct OPS *)record_gen_parms_ops);
        add_selector_info("unknown", 8, (struct OPS *)null_ops);
        add_selector_info("xclu", 9, (struct OPS *)record_idn_parms_ops);
        add_selector_info("xsel", 10, (struct OPS *)record_idn_parms_1_ops);
        find_selector_ops("oneof", 11, &(oneof_any__apply_cluster__cvt__idn_other_select_type__unknown_xclu_xsel_ops));
        add_parm_info_type(0, (const struct OPS *)oneof_any__apply_cluster__cvt__idn_other_select_type__unknown_xclu_xsel_ops, table_of_key_reqs);
        add_parm_info_type(1, (const struct OPS *)typespec_ops, table_of_val_reqs);
        ...
        add_parm_info_type(0, (const struct OPS *)du_ops, table_of_key_reqs);
        add_parm_info_type(1, (const struct OPS *)bool_ops, table_of_val_reqs);
        find_type_instance(table_ops, 2, &table_ownreqs, &(table_of_du_bool_ops));
        add_parm_info_type(0, (const struct OPS *)string_ops, table_of_key_reqs);
        add_parm_info_type(1, (const struct OPS *)record_code_kind_ops, table_of_val_reqs);
        add_parm_info_type(2, (const struct OPS *)bool_ops, table_op_pcond_flush_of_u_reqs);
        find_type_instance(table_ops, 2, &table_ownreqs, &(table_of_string_record_code_kind_ops));
        ...
        add_parm_info_type(0, (const struct OPS *)oneof_any__apply_cluster__cvt__idn_other_select_type__unknown_xclu_xsel_ops, table_of_key_reqs);
        add_parm_info_type(1, (const struct OPS *)typespec_ops, table_of_val_reqs);
        add_parm_info_type(2, (const struct OPS *)int_ops, table_op_pcond_flush_of_u_reqs);
        find_type_instance(table_ops, 2, &table_ownreqs, &(table_of_oneof_any__apply_cluster__cvt__idn_other_select_type__unknown_xclu_xsel_typespec_ops));
...
ceOPreset(CLUREF e)
{
  ...
  LINE(185);
    ...
    locals.err = proctypeOPnew(CLU_0, &T_1_2);
    if (locals.err != ERR_ok)
        goto ex_0;
...
ceOPkeep_IB_1(CLUREF iv_1, CLUREF iv_2, ceOPkeep_LOCALS_t *locals, errcode *iecode)
{
    locals->d.num = iv_1.num;
    locals->flush.num = iv_2.num;
    enter_iter_body_proc(224);

  FB_LINE(224);
    { /* if */
    if (locals->flush.num == true) { /* if */
...
ceOPlookup(CLUREF e, CLUREF s, CLUREF line, CLUREF *ret_1)
{
  ...
  LINE(238);
        ...
        CLUREF T_2_4;
        T_2_2.num = -1;
        T_2_3.num = (code.num == T_2_2.num);
        T_2_1.num = T_2_3.num;
        if (!T_2_3.num) {
            T_2_4.num = (code.num == 0);
            T_2_1.num = T_2_4.num;
        }
        if (T_2_1.num == true) { /* if */
...
errcode
ceOPget_xlib(CLUREF e, CLUREF *ret_1)
{
    errcode err;
    if (ce_own_init == 0) {
        err = ce_own_init_proc();
...
static CLU_proc ce_oe_get_xlib = { .proc = ceOPget_xlib };
...
static ce_OPS ce_ops_actual = {32, (OWNPTR)&ce_own_init, (OWNPTR)&ce_own_init, {
    {&ce_oe_add_du, "add_du"},
...
static CLUREF STR_illegal_137typespec;
...
hash_typeabs(CLUREF ta, CLUREF z, CLUREF *ret_1)
{
    ...
    if (hash_typeabs_own_init == 0) {
        stringOPcons("illegal_typespec", CLU_1, CLUREF_make_num(16), &STR_illegal_137typespec);
