...
static CLUREF STR_Created_040twice;
...
static CLUREF STR_get_040before_040create;
...
xlib_own_init_proc(void)
{
    ...
    if (xlib_own_init == 0) {
        ...
        stringOPcons("Created twice", CLU_1, CLUREF_make_num(13), &STR_Created_040twice);
        ...
        stringOPcons("get before create", CLU_1, CLUREF_make_num(17), &STR_get_040before_040create);
...
static int xlibOPcreate_own_init = 0;
...
xlibOPcreate(CLUREF *ret_1)
{
    ...
    if (xlibOPcreate_own_init == 0) {
        ...
        xlibOPcreate_own_init = 1;
    }
    enter_proc(26);

  LINE(27);
    { /* if */
    if (xlibOPcreated_before.num == true) { /* if */
        { /* signal */
            elist[0] = STR_Created_040twice;
            signal(ERR_failure);
        }
    }
    } /* end if */
...
/**** BEGIN PROCEDURE get2 ****/

static int xlibOPget2_own_init = 0;

errcode
xlibOPget2(CLUREF *ret_1)
{
    errcode err;
    if (xlibOPget2_own_init == 0) {
        if (xlib_own_init == 0) {
            err = xlib_own_init_proc();
            if (err != ERR_ok)
                goto ex_0;
        }
        xlibOPget2_own_init = 1;
    }
    enter_proc(47);
  ...
  LINE(48);
    { /* if */
    CLUREF T_1_1;
    T_1_1.num = !xlibOPcreated_before.num;
    if (T_1_1.num == true) { /* if */
        { /* signal */
            elist[0] = STR_get_040before_040create;
            signal(ERR_failure);
        }
    }
    } /* end if */
...
xlibOPlookup2(CLUREF xl, CLUREF path, CLUREF *ret_1)
{
  ...
  LINE(54);
    ...
    CUR_PROC_VAR.proc = &generic_CLU_proc;
    err = tableOPlookup(xl, path, &T_2_1);
    if (err != ERR_ok)
        goto ex_1;
    ret_1->num = T_2_1.num;
    }
...
xlibOPdump_IB_1(CLUREF iv_1, CLUREF iv_2, xlibOPdump_LOCALS_t *locals, errcode *iecode)
{
  ...
  FB_LINE(76);
        ...
        if ((locals->list.array->int_low + locals->list.array->ext_size + 1) < locals->list.array->int_size) {
            ...
            locals->list.array->ext_size++;
            locals->list.array->ext_high++;
        }
        else {
...
static CLU_proc xlib_oe_create = { .proc = xlibOPcreate };
...
static xlib_OPS xlib_ops_actual = {8, (OWNPTR)&xlib_own_init, (OWNPTR)&xlib_own_init, {
    {&xlib_oe_bind, "bind"},
    {&xlib_oe_create, "create"},
    {&xlib_oe_dump, "dump"},
    {&xlib_oe_get2, "get2"},
